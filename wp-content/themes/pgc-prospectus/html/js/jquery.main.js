...
function initTabs() { 
	...
	$('.block-achievers .tab-content').hide();
	$('.block-achievers .tab-content:first').show();
...
function initCustomInputFile() {
	...
	if (jQuery('input[type="file"]')[0]) {
		var fileInput = document.querySelector('label[for="file-upload"]');
		...
		jQuery('#file-upload').change(function() {
			var fileNames = jQuery('#file-upload')[0].files[0].name;
